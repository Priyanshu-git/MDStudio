...
- User can switch between desktop split/preview modes and mobile write/preview/outline/files tabs.
- User can preview secure markdown with GFM, math, code highlighting, and Mermaid diagrams.
- User can sign in with Google, publish a share link, copy an existing link, and sign out through an account menu with inline confirmation.
